                ...
                <div className="container">
                    ...
                    <div className="wrapper-elements">
                        <div className="wrapper">
                            ...
                            <ModalWindow
                                title={'Veb mahsulotlar'}
                                text="Biznesingiz uchun funksional platformalar, veb ilovalar, tashrif saytlari va telegram botlari bo'lishini ta'minlaymiz."
                        ...
                        <div className="wrapper">
                            ...
                            <ModalWindow
                                ...
                                text="Loyihalar uchun mobil ilovalar yaratish. Mavjud tizimlarni Android va iOS tizimlariga o'tkazish. Mijozlar uchun mobil ilovalar yaratish"
                        ...
                        <div className="wrapper">
                            ...
                            <ModalWindow
                                ...
                                text={'Qidiruv tizimlari orqali optimizatsiya, ularni tahlil qilish. Mijozlar oqimini rivojlantirish va SMM xizmatlari.'}
